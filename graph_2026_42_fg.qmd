...
author:
  - name: François Geerolf
    email: "francois.geerolf@sciencespo.fr"
    affiliation: OFCE, Sciences Po Paris
    affiliation-url: "http://www.ofce.fr"
    
description: "Selon certains économistes, la courbe de Phillips aurait disparu, ou dépendrait du régime de change. En réalité, elle reste remarquablement robuste pour la France... à condition d’autoriser une forme piscicole.🐟"

date: 2026-04-01
categories: ["inflation", "chômage", "France", "Phillips"]

urlblog: "https://ofce.github.io/GraphOftheWeek_Relecture/relecture/nom_du_qmd.html"

nb: 42 # 42 est tout simplement la réponse à la grande question sur la vie, l'univers et le reste. Autrement dit la réponse à tout, y compris l'existence de la courbe de Phillips.
...
interp_data <- with(fish_scaled,
                    akima::interp(
                      x, y, z = y,
                      duplicate = "mean",
                      nx = n_colonnes,   # ← plus de colonnes
                      ny = n_lignes    # ← plus de lignes
                    ))
...
# garder seulement les points dans le poisson
